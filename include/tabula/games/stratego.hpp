...
using basic_stratego = basic_board<rectangle{.width = Width, .height = Height}, Lake, Padding>;
...
using l_attaque = basic_stratego<9, 10, basic_lake<"c6"_sq, "e6"_sq, "g6"_sq, "c5"_sq, "e5"_sq, "g5"_sq>>;

// Classic Stratego is played on a 10x10 board
// with two 2x2 lakes on the 5th and 6th rows of the c, d, g and h files.
using classic = basic_stratego<10, 10, basic_lake<"c6"_sq, "d6"_sq, "g6"_sq, "h6"_sq, "c5"_sq, "d5"_sq, "g5"_sq, "h5"_sq>>;
...
using quick_arena = basic_stratego<8, 8, basic_lake<"c5"_sq, "f5"_sq, "c4"_sq, "f4"_sq>>;
