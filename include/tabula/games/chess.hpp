...
#include <tabula/padding.hpp>   // mailbox, padding, pad_right

namespace tabula {

template<int Width, int Height, class Lake = basic_lake<>, padding Padding = pad_right(0)>
...
using board_10x12    = basic_chess< 8,  8, basic_lake<>, mailbox(2, 1)>;
...
using board_16x12    = basic_chess< 8,  8, basic_lake<>, mailbox(2, 4)>;
using board_16x16    = basic_chess< 8,  8, basic_lake<>, mailbox(4, 4)>;

// https://en.wikipedia.org/wiki/Capablanca_chess
using capablanca     = basic_chess<10,  8, basic_lake<>, mailbox(2, 1)>;

// https://en.wikipedia.org/wiki/Grand_chess
using grand          = basic_chess<10, 10, basic_lake<>, mailbox(2, 1)>;
