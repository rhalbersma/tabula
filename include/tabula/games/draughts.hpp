...
template<int Width, int Height, int Parity = 0, class Padding = right_padding<1>, class... Cuts>
...
using mertens_cut_j10   = basic_draughts<10, 10, 0, right_padding<1>, cut<'j',10>>;
using mertens_add_k9    = basic_draughts<11, 10, 0, right_padding<1>, cut<'k',7>, cut<'k',5>, cut<'k',3>, cut<'k',1>>;
