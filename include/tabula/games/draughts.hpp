...
using latin = basic_draughts<8, 8, true>;
using italian = latin;
using spanish = latin;

using international = basic_draughts<10, 10>;
using frisian = basic_draughts<10, 10, false, basic_lake<>, pad_right(2)>;
using canadian = basic_draughts<12, 12>;
using sri_lankan = basic_draughts<12, 12, true>;
...
using ktar = basic_draughts<Width, Height, true>;
...
using mertens_cut_j10 = basic_draughts<10, 10, false, basic_lake<"j10"_sq>>;
using mertens_add_k9 = basic_draughts<11, 10, false, basic_lake<"k7"_sq, "k5"_sq, "k3"_sq, "k1"_sq>>;
