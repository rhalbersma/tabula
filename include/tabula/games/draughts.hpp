...
#ifndef TABULA_GAMES_DRAUGHTS_HPP
#define TABULA_GAMES_DRAUGHTS_HPP
...
template<int Width, int Height, int Parity = 1, class Lake = basic_lake<>, padding Padding = pad_right(1)>
...
using frisian           = basic_draughts<10, 10, 1, basic_lake<>, pad_right(2)>;
...
using mertens_cut_j10   = basic_draughts<10, 10, 1, basic_lake<"j10"_sq>>;
using mertens_add_k9    = basic_draughts<11, 10, 1, basic_lake<"k7"_sq, "k5"_sq, "k3"_sq, "k1"_sq>>;
...
#endif // TABULA_GAMES_DRAUGHTS_HPP
