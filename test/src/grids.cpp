...
constexpr auto d8_grids = std::tuple{rectangle{1, 1}, rectangle{2, 2}, rectangle{3, 3}, rectangle{4, 4}, rectangle{5, 5}, rectangle{6, 6}, rectangle{7, 7}, rectangle{8, 8}, chequer{1, 1, 0}, chequer{1, 1, 1}, chequer{3, 3, 0}, chequer{3, 3, 1}, chequer{5, 5, 0}, chequer{5, 5, 1}, chequer{7, 7, 0}, chequer{7, 7, 1}};
...
constexpr auto d4c_grids = std::tuple{rectangle{1, 2}, rectangle{1, 2}, rectangle{1, 3}, rectangle{1, 3}, rectangle{2, 1}, rectangle{2, 1}, rectangle{2, 3}, rectangle{2, 3}, chequer{1, 3, 0}, chequer{1, 3, 1}, chequer{1, 5, 0}, chequer{1, 5, 1}, chequer{3, 1, 0}, chequer{3, 1, 1}, chequer{3, 5, 0}, chequer{3, 5, 1}};
...
constexpr auto d4o_grids = std::tuple{chequer{2, 2, 0}, chequer{2, 2, 1}, chequer{4, 4, 0}, chequer{4, 4, 1}, chequer{6, 6, 0}, chequer{6, 6, 1}, chequer{8, 8, 0}, chequer{8, 8, 1}};
...
constexpr auto d2v_grids = std::tuple{chequer{2, 1, 0}, chequer{2, 1, 1}, chequer{2, 3, 0}, chequer{2, 3, 1}, chequer{4, 1, 0}, chequer{4, 1, 1}, chequer{4, 3, 0}, chequer{4, 3, 1}};
...
constexpr auto d2h_grids = std::tuple{chequer{1, 2, 0}, chequer{1, 2, 1}, chequer{1, 4, 0}, chequer{1, 4, 1}, chequer{3, 2, 0}, chequer{3, 2, 1}, chequer{3, 4, 0}, chequer{3, 4, 1}};
...
constexpr auto d2r_grids = std::tuple{chequer{2, 4, 0}, chequer{2, 4, 1}, chequer{2, 6, 0}, chequer{2, 6, 1}, chequer{4, 2, 0}, chequer{4, 2, 1}, chequer{4, 6, 0}, chequer{4, 6, 1}};
...
constexpr auto grids = std::tuple_cat(d8_grids, d4c_grids, d4o_grids, d2v_grids, d2h_grids, d2r_grids);
